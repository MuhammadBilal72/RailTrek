...
<head>
  ...
  <title>
    RailTrek Admin | Create New Schedule
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="card mb-4">
            ...
            INNER JOIN 
                ...
                <div class="form-group">
                  ...
                  <select name="route" class="form-select">
                    ...
                    foreach ($routes as $route) {
                      echo '<option value="' . $route["id"] . '">'.$route["start_station_name"].'-'.$route["end_station_name"].'</option>';
                    }
                    ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="time" class="form-control" name="arrTime"/>
                </div>
                <div class="form-group">
