...
<head>
  ...
  <title>
    RailTrek Admin | New Train Requests
  </title>
  <!--     Fonts and icons     -->
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    ...
                    <?php
                    $train_requests = getData($conn, "select * from new_train_request");
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $user_data[0]["fullname"]; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
